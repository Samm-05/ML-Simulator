...
const APP_SHELL_ROUTES = ['/dashboard', '/neural-network', '/linear-regression', '/logistic-regression', '/gradient-descent', '/simulator', '/practice', '/leaderboard', '/profile', '/settings'];
