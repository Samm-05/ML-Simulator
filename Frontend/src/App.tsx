...
const APP_SHELL_ROUTES = ['/dashboard', '/neural-network', '/linear-regression', '/logistic-regression', '/gradient-descent', '/overfitting-lab', '/practice', '/leaderboard', '/profile', '/settings'];
